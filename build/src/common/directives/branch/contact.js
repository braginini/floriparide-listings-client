System.registerModule("src/common/directives/branch/contact.js", [], function() {
  "use strict";
  var __moduleName = "src/common/directives/branch/contact.js";
  var $__default = angular.module('directives.contact', ['services.util']).directive('branchContact', [function() {
    return {
      restrict: 'EA',
      templateUrl: 'directives/branch/contact.tpl.html',
      replace: true,
      scope: {c: '=branchContact'},
...
//# sourceURL=src/common/directives/branch/contact.js
