System.registerModule("src/common/directives/frames.js", [], function() {
  "use strict";
  var __moduleName = "src/common/directives/frames.js";
  var $__default = angular.module('directives.frames', []).directive('frames', ['$timeout', '$window', function($timeout, $window) {
    return {
      restrict: 'EC',
      replace: false,
...
//# sourceURL=src/common/directives/frames.js
