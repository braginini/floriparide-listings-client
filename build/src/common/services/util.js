System.registerModule("src/common/services/util.js", [], function() {
  "use strict";
  var __moduleName = "src/common/services/util.js";
  var urlPattern = /((http|ftp|https):\/\/)*[\w-]+(\.[\w-]+)+([\w.,@?^=%&amp;:\/~+#-]*[\w@?^=%&amp;\/~+#-])?/gi;
  var $__default = angular.module('services.util', []).factory('util', [function() {
    var me = {
...
//# sourceURL=src/common/services/util.js
